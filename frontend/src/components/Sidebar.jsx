...
import { X, LogOut, Briefcase, Users } from 'lucide-react';
  ...
  return (
    <>
      ...
      >
        {/* Top Header / Branding */}
        <div>
          <div className="h-16 px-5 flex items-center justify-between border-b border-[#E7E9EE] dark:border-[#262B35]">
          ...
          {/* Role Status Tag */}
          <div className="px-5 py-3 border-b border-[#E7E9EE] dark:border-[#262B35] bg-[#F5F7FB]/50 dark:bg-[#0F1115]/40 flex items-center justify-between">
            ...
            {navItems.map((item) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) => `
                    group flex items-center gap-3 px-3.5 py-2.5 rounded-[10px] text-xs font-medium transition-all duration-150
                    ${
                      isActive
        ...
        <div className="p-3 border-t border-[#E7E9EE] dark:border-[#262B35]">
          <div className="p-2.5 rounded-[10px] bg-[#F5F7FB] dark:bg-[#0F1115] border border-[#E7E9EE] dark:border-[#262B35] flex items-center justify-between gap-2">
