...
- **Phase 6+ (Upcoming)**: Interviewer assignments, scorecard reviews, timeline query APIs, and stalled application SLA alerts.
...
- Intentionally deferred Interview Panel management, `/my-reviews`, scorecard grading, search/pagination, bulk CSV exports, and SLA stall alerts to their designated future phases.
